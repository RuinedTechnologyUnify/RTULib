...
public class JsonStorage implements Storage {
    ...
    public boolean add(String name, JsonObject data) {
        if (!map.containsKey(name)) {
            RTULib.getPlugin().console(ComponentUtil.miniMessage("<red>Can't load " + name + " data!</red>"));
            RTULib.getPlugin().console(ComponentUtil.miniMessage("<red>" + name + " 파일을 불러오는 도중 오류가 발생하였습니다!</red>"));
            return false;
        }
